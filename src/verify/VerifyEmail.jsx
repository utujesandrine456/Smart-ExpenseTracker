            ...
            <div className='flex flex-col w-full h-full text-center px-[80px] bg-[#fff] ' >
                ...
                <div className='bg-[#1c1206] p-3 text-[#577F26] '>
                    ...
                    <div className='flex  justify-center align-center mb-3'>
                        <a href="#" className=' font-bold text-[18px] underline hover:text-white transition-all duration-400 ease-in-out' onClick={handleResendCode}>{ resendingLoading ? 'Resending...' : 'Resend Code'}</a>
                    </div>
                </div>
